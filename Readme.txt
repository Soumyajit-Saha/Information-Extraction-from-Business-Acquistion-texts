Program Name : InfoExtract.py 
The program takes around 1.5 hours for training. The program generates a template file with name <input_file>.templates as per the given directory.
